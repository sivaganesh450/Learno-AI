    ...
    async def stream_generator():
        ...
        try:
            ...
            if request.agent_type == "roadmap":
                ...
                # Reconstruct quiz session from DB if needed (handles Lambda cold starts)
                chat_history = await agent_chat_service.get_conversation_history(
                    chat.chat_id, user_id, limit=100
                )
                quiz_agent.load_history_from_chat(session_key, chat_history)
